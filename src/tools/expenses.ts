...
export const getExpensesTool: Tool = {
    ...
    inputSchema: {
      ...
      properties: {
        filter_by: { 
          type: "string", 
          description: "Filter expenses by status (e.g., 'Status.All', 'Status.Billable', 'Status.Nonbillable')", 
          enum: ["Status.All", "Status.Billable", "Status.Nonbillable", "Status.Reimbursed", "Status.Invoiced", "Status.Unbilled"]
        },
        sort_column: { 
          type: "string", 
          description: "Column to sort results by", 
          enum: ["date", "account_name", "total", "bcy_total", "reference_number", "customer_name", "created_time"]
        },
        customer_id: { type: "string", description: "Filter expenses by customer ID" }
      },
      required: []
    }
  };
...
export const getEmployeeTool: Tool = {
    ...
    inputSchema: {
      type: "object",
      properties: {
        employee_id: { type: "string", description: "ID of the employee to fetch" },
      },
